...
alias ii='screen -dr || screen /usr/bin/irssi'
alias config='/usr/bin/git --git-dir=/home/dcollins/.cfg/ --work-tree=/home/dcollins'
alias diff="ccdiff --bg=none"

export LD_LIBRARY_PATH="/usr/local/lib"
export PATH=$PATH:/usr/local/krb5/bin/:~/.local/bin/
export EDITOR=vim
